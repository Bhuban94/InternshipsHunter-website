...
--
-- Host: localhost
-- Generation Time: Apr 06, 2014 at 03:15 PM
...
-- Database: `bhuban`
--
CREATE DATABASE IF NOT EXISTS `bhuban` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `bhuban`;
...
('Rohan', 'Bhoi', 'rocker', 'bhoirohan@gmail.com', 8763988117, 'Berhampur', 19, 'M', '2014-03-24', 'c,c++,java,php,html,perl,python', 'xilinx,photoshop,dreamweaver'),
('Bhubanananda', 'Chhatriya', 'qwerty', 'bhubananandachhatriya@gmail.com', 7381828134, 'Sambalpur', 20, 'M', '1994-04-30', 'java,c++,c,php,html,css', 'photoshop,dreamweaver,eclipse,netbeans,xilinx');
